...
func TestInitErrors(t *testing.T) {
	...
	var initErrorsTests = []struct {
		...
		{"TestInitWithBadRepoUrlConfig", []string{"nodejs-express"}, "bad_repo_url_repository_config", "The following indices could not be read. Does the APIVersion of your repository match what the Appsody CLI currently supports?", "Correct error message not given"},
